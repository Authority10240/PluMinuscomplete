  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        overlayShadow: false,
        images: [
          AssetImage('assets/img/coin-jar.jpeg'),
          AssetImage("assets/img/fin-ball.jpg"),
          AssetImage('assets/img/coins.jpeg'),
          AssetImage("assets/img/main-fin.jpg"),
        ],
      ),
          ),
         Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                "Login To join Plus+-Minus Accountability",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 17.0,
                            ...
                            tapLogin == 0
                                ? Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: ButtonCustom(txt: "Sign Me Up"),
                                    ),
                                  )
                        ...
                        tapSignup == 0
                            ? Material(
                                ...
                                child: InkWell(
                                  ...
                                  child: ButtonCustom(txt: "I Have An  Account"),
                                ),
                              )
